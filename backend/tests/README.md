...
| `pages/training/index.vue` 今日训练 | `/api/training/*` | `test_module_training.py`, `test_training_api.py` |
| `pages/qa/index.vue` 学科答疑 | `POST /api/qa/chat` | `test_module_qa.py` |
| `pages/growth/index.vue` 成长里程碑 | `/api/growth/*` | `test_module_growth.py` |
| 用户注册（全局） | `/api/auth/*`, `/api/user/profile` | `test_module_auth.py` |
