      ...
      <view class="content">
        ...
        <view class="card hero-row" style="position:relative;overflow:hidden;">
          ...
          <view class="hero-info" style="position:relative;z-index:1;">
            <text class="hero-label">你是！</text>
            <text class="hero-name">{{ talentDisplay }}</text>
            <text class="hero-desc">{{ attrShort }}</text>
          </view>
          <image src="/static/学者.png" style="position:absolute;right:-30px;top:-10px;width:170px;height:180px;opacity:0.3;pointer-events:none;object-fit:cover;object-position:top;" />
        </view>
        ...
        <view class="card" style="text-align:center;padding:16px;position:relative;">
          <image src="/static/report-avatar.png" mode="widthFix" style="width:100%;max-width:360px;display:block;margin:0 auto;" />
          <view v-html="miniRadarSvg" style="position:absolute;top:50%;left:45%;transform:translate(-50%,-50%);pointer-events:none;width:150px;"></view>
        </view>
...
const loadError = ref('')
const USE_MOCK = true  // 原型预览用 mock 数据
...
function getMockData() {
  return {
    id: 1, talent: '学者', talent_primary: '学者', check_talent: ['学者', '德者'],
    create_time: '2026-07-01 12:00',
    results: {
      Talent: { value: 85, desp: '<p><strong>天赋能力解读</strong></p><p>学者型的人天生对世界充满好奇，喜欢系统性思考，善于从复杂信息中提炼规律。</p><p><strong>想对你说的话</strong></p><p>你的逻辑分析能力非常出色，继续保持好奇心！</p><p><strong>三条黄金建议</strong></p><p>1. 每天留出30分钟深度阅读</p><p>2. 把学到的知识讲给别人听</p><p>3. 每周做一件不需要过度思考的事</p>' },
      Attribute: { desp: '拥有卓越的逻辑分析能力和对新知识的强烈渴求', SupplementDesp: '<p>学者偏德者，智德双修，既有学者的深度思考，又有德者的仁爱之心。</p>', attributeList: [{ id: 'A', name: '智慧', grade: 5, value: 92 }, { id: 'B', name: '思辨', grade: 4, value: 85 }, { id: 'C', name: '专注', grade: 4, value: 78 }, { id: 'D', name: '洞察', grade: 3, value: 65 }, { id: 'E', name: '求知', grade: 5, value: 90 }], attribute: { id: 'A', name: '智慧', grade: 5, value: 92 } },
      State: { name: '平稳', id: 4, desp: '<p>当前状态平稳，适合深入学习。给你的建议：事业建议：适合科研、教育、技术分析等方向。情感建议：擅长理解他人，需更主动表达。</p>' },
      Ability: [
        { abilityID: 1, abilityName: '协调力', value: 78, desp: '协调力表现不错' },
        { abilityID: 2, abilityName: '执行力', value: 65, desp: '执行力有待提升' },
        { abilityID: 3, abilityName: '公信力', value: 55, desp: '公信力需要加强' },
        { abilityID: 4, abilityName: '领导力', value: 85, desp: '领导力突出' },
        { abilityID: 5, abilityName: '创新力', value: 92, desp: '创新力是你的强项' },
      ],
    },
  }
}
