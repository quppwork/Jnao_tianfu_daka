...
const SKILL_META = {
  超脑阅读: { emoji: '📖', img: '/static/dayu/assets/miji/mj-tfsd.jpg', mj: '吸照大法' },
  影像追忆: { emoji: '🧠', img: '/static/dayu/assets/miji/sys-drama.jpg', mj: '无相神功' },
  扫描速记: { emoji: '🌸', img: '/static/dayu/assets/miji/mj-tfsd.jpg', mj: '昙花宝典' },
  极速运算: { emoji: '⚡', img: '/static/dayu/assets/miji/sys-contest.jpg', mj: '极速运算' },
  极速学习: { emoji: '🚀', img: '/static/dayu/assets/miji/sys-contest.jpg', mj: '太极神功' },
  难题专练: { emoji: '🎯', img: '/static/dayu/assets/miji/sys-contest.jpg', mj: '难题专练' },
  文科扫书: { emoji: '📚', img: '/static/dayu/assets/miji/mj-tfsd.jpg', mj: '文科扫书' },
  理科扫书: { emoji: '🔬', img: '/static/dayu/assets/miji/sys-contest.jpg', mj: '理科扫书' },
  高效作业: { emoji: '✏️', img: '/static/dayu/assets/miji/sys-drama.jpg', mj: '高效作业' },
  多元感知: { emoji: '🎧', img: '/static/dayu/assets/miji/mj-tfsd.jpg', mj: '六感神剑' },
  感知力: { emoji: '🎧', img: '/static/dayu/assets/miji/mj-tfsd.jpg', mj: '六感神剑' },
  开口窍: { emoji: '🗣️', img: '/static/dayu/assets/miji/sys-drama.jpg', mj: '心门九剑' },
  精力恢复: { emoji: '🍃', img: '/static/dayu/assets/miji/sys-drama.jpg', mj: '呼吸打坐' },
}
