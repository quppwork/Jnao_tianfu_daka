...
| **[外部接入与上游API](docs/外部接入与上游API.md)** | 豆包 / 百炼 RAG / OSS / JNAO 等对外依赖 |
| **[前端对接API契约](docs/前端对接API契约.md)** | **给外部前端**：HTTP 鉴权与接口契约（无需源码） |
| **[技术现状与智能体上架评估](docs/技术现状与智能体上架评估.md)** | 技术栈 / 完成度 / 距首发智能体上架 |
| **[前端更新 · 大宇壳页双轨](docs/前端更新-大宇壳页双轨现状.md)** | 壳 Demo vs 老业务页：互跳、重叠、未接 API |
