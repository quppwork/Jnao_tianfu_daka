...
> **怎么扩写**：见 [_templates/](./_templates/README.md)；口径冲突先查文末「裁定纪要」。
...
| 层 | 目录 | 回答的问题 | 主要文件 |
|----|------|------------|----------|
| **L1** | [foundations/](./foundations/README.md) | 大脑与五者的「为什么」 | [theory](./foundations/theory.md) · [talents](./foundations/talents.md) |
| **L2** | [practice/](./practice/README.md) | 这个孩子 / 这对父母怎么做 | [talents-application](./practice/talents-application.md) · [learning-methods](./practice/learning-methods.md) · [parent-child/](./practice/parent-child/README.md) |
| **L3** | [training/](./training/README.md) | 练什么、怎么晋级、出事怎么办 | [methods](./training/methods.md) · [safety](./training/safety.md) |
| **L4** | [delivery/](./delivery/README.md) | 团队如何标准化交付 | [framework](./delivery/training-system-framework.md) · [SOP](./delivery/delivery-escort-sop.md) |
| **L5** | [frontline/](./frontline/README.md) | 招生转化与产品话术 | [sales](./frontline/sales.md) · [quotes](./frontline/quotes.md) · [cases](./frontline/cases.md) · [products](./frontline/products.md) · [technology](./frontline/technology.md) |
| — | [internal/](./internal/README.md) | 不对家长原文照念 | [management](./internal/management.md) · [agent-instruction](./internal/agent-instruction.md) |
...
| 家长×孩子话术 | [practice/parent-child/](./practice/parent-child/) | sales = 跨组合通则 |
...
- 短剧：[《天赋物语》](../talent-drama/README.md)
- 财务：[财务合规与多主体运营](../finance-ops/README.md)
