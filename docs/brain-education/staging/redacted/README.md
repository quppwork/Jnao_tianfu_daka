...
<!-- canonical-banner -->
> **文档角色**：`index`　**主题**：知识包总索引、口径裁定纪要入口
> **说明**：索引与裁定入口；非主题权威全文
<!-- /canonical-banner -->
整理自：线下大会演讲转写 + 《天赋物语》短剧素材 + 《超脑进化之书》精读 + 同事汇总资料包。
...
- **已救回归档**：`meta/_raw/team-pack/`、`meta/transcript-screening-2026-08-28.md`（原误放在临时目录，已迁入）

---


> **权威口径全文**：冲突时以同目录 [`canon.md`](./canon.md) 为准（本 README 的裁定纪要已固化至该文件）。
